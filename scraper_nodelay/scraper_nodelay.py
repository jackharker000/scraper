...
MAX_CONCURRENT = 5
DELAY = 0  # no delay between page fetches
...
async def fetch_with_retry(
    ...
    """GET *url* and return the response text. Retries on network errors or
    non-200 responses. Returns '' on failure."""
...
# ---------------------------------------------------------------------------
# High-level entry points (called from main_nodelay.py)
# ---------------------------------------------------------------------------
